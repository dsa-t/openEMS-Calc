...
public:
    ...
    CSPropMaterial* AddMaterial(const std::string& name, double epsilon = 1.0, double mue = 1.0, double kappa = 0.0, double sigma = 0.0, double density = 0.0) {
    ...
    CSPropLumpedElement* AddLumpedElement(const std::string& name) {
    ...
    CSPropConductingSheet* AddConductingSheet(const std::string& name) {
    ...
    CSPropExcitation* AddExcitation(const std::string& name, int exc_type, std::array<double,3> exc_val) {
    ...
    CSPropProbeBox* AddProbe(const std::string& name, int p_type) {
